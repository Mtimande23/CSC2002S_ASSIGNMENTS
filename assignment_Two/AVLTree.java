// Hussein's AVL Tree(modified/added on by Themba Shongwe)
// 26 March 2025.
// Hussein Suleman
...
{
   int opCountSearch=0, opCountInsert=0;
   ...
   public void setInsertCount(){
      this.opCountInsert=0;
   }
   public int getSearchCount(){
      return this.opCountSearch;
   }

   public int getInsertCount(){
      return this.opCountInsert;
   }
}
